...
Shared messaging interfaces and Kafka publishers.
...
Defines the `DomainEventPublisher` interface. Implementing microservices use this library to emit events asynchronously over Apache Kafka, facilitating the Event-Driven Microservices architecture.
...
mvn spring-boot:run -pl common-messaging
```
