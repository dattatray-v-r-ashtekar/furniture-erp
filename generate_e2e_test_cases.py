...
e2e_cases = """# End-to-End (E2E) Real-Life Test Scenarios
...
with open("docs/end-to-end-test-cases.md", "w", encoding="utf-8") as f:
    f.write(e2e_cases)

print("Generated End-to-End test cases in docs/end-to-end-test-cases.md")
