...
test_cases_content = """# Comprehensive Manual Test Plan
...
with open("docs/manual-test-cases.md", "w", encoding="utf-8") as f:
    f.write(test_cases_content)

print("Generated manual test cases in docs/manual-test-cases.md")
